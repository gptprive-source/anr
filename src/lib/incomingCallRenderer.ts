...
export const showIncomingCall = (data: IncomingCallData) => {
  ...
  container.innerHTML = `
    ...
    <div style="display: flex; gap: 24px; position: relative; z-index: 10; align-items: flex-start;">
      <div style="display: flex; flex-direction: column; align-items: center; min-height: 140px;">
        <div id="decline-swipe-container" style="display: flex; flex-direction: column; align-items: center; touch-action: none; user-select: none;">
          <div id="decline-arrow" style="color: #94a3b8; margin-bottom: 4px; opacity: 0.3; transition: all 0.2s; height: 20px;">
          ...
          <span style="font-size: 13px; color: #94a3b8; margin-top: 8px;">Refuser</span>
          <span style="font-size: 11px; color: #64748b; margin-top: 2px;">↑ Glisser</span>
        </div>
      </div>

      <div style="display: flex; flex-direction: column; align-items: center; min-height: 140px; padding-top: 24px;">
        ...
        <span id="mute-label" style="font-size: 13px; color: #94a3b8; margin-top: 8px;">Silence</span>
      </div>
      ...
      <div style="display: flex; flex-direction: column; align-items: center; min-height: 140px; padding-top: 24px;">
        ...
        <span style="font-size: 13px; color: #94a3b8; margin-top: 8px;">Voir</span>
      </div>
      ...
      <div style="display: flex; flex-direction: column; align-items: center; min-height: 140px;">
        <div id="answer-swipe-container" style="display: flex; flex-direction: column; align-items: center; touch-action: none; user-select: none;">
          <div id="answer-arrow" style="color: #94a3b8; margin-bottom: 4px; opacity: 0.3; transition: all 0.2s; height: 20px;">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M12 19V5M5 12l7-7 7 7" />
            </svg>
          </div>
          ...
          <span style="font-size: 13px; color: #94a3b8; margin-top: 8px;">Répondre</span>
          <span style="font-size: 11px; color: #64748b; margin-top: 2px;">↑ Glisser</span>
        </div>
      </div>
    </div>

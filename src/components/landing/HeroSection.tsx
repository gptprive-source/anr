  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        animationDelay: "0.4s"
          ...
          <Button variant="glass" size="xl" onClick={() => navigate("/visitor")} className="shadow-none rounded-none border border-solid border-success">J'appelle un résident<QrCode className="w-5 h-5" />

...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-start justify-center overflow-hidden px-4 pt-6 pb-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        {/* Feature cards */}
        <div
          className="grid md:grid-cols-4 gap-4 animate-fade-in"
          style={{
        ...
        >
          <FeatureCard
            ...
            title="QR Code & NFC"
            description="Le visiteur scanne votre ANR avec son téléphone pour sonner instantanément"
            color="blue"
          />
          <FeatureCard
            icon={<Smartphone className="w-6 h-6" />}
            title="Vidéo HD"
            description="Votre téléphone sonne et voyez le visiteur avant de répondre, où que vous soyez"
            color="orange"
          />
          <FeatureCard
            icon={<MessageSquare className="w-6 h-6" />}
            title="Communiquez"
            description="Parlez et échangez des messages chiffrés avec vos visiteurs, texte, vocal et vidéos"
            color="purple"
          />
          <FeatureCard

...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-start justify-center overflow-hidden px-4 pt-6 pb-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        {flags.carrierModuleEnabled && <div className="mb-12 animate-fade-in" style={{
        animationDelay: "0.5s"
      }}>
...
const FeatureCard = ({
  ...
  return <div className="bg-card/80 backdrop-blur-xl rounded-2xl p-6 card-shadow transition-colors text-center" style={{

    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-12">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            >
              <Button
                ...
                className="!border-2 !border-blue-400 ring-4 ring-blue-400/40 shadow-[0_0_20px_rgba(96,165,250,0.4)]"
              >
          ...
          <div
            className="relative flex items-center justify-center order-1 lg:order-2 animate-fade-in"
            style={{ animationDelay: "0.3s" }}
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div
                className="absolute w-72 h-72 md:w-96 md:h-96 rounded-full border border-primary/10 animate-ping-slow"
                style={{ animationDelay: "0.5s" }}
              />
              <div
                className="absolute w-80 h-80 md:w-[28rem] md:h-[28rem] rounded-full border border-primary/5 animate-ping-slow"
            ...
            <div className="relative z-10 animate-float">
              <img
                src={anrBadge}
                alt="Badge ANR - Adresse Numérique Résidentielle"
                className="w-48 h-48 md:w-64 md:h-64 lg:w-72 lg:h-72 object-contain drop-shadow-2xl hover:scale-105 transition-transform duration-300"
              />
            </div>

            {/* Floating label */}
            <div
              className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-card/90 backdrop-blur-sm border border-border rounded-full px-4 py-2 shadow-lg animate-fade-in"
              style={{ animationDelay: "0.6s" }}
            >
              <span className="text-sm font-medium text-foreground">Scannez pour appeler</span>
            </div>
          </div>
        </div>
      </div>

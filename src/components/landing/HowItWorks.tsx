...
const steps = [
  {
    ...
    title: "Scanner",
    description: "Le visiteur scanne votre plaque ANR avec son téléphone",
    color: "blue",
  },
  {
    ...
    <section className="py-20 px-4 relative">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">Simple, rapide et sécurisé</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12">
          {steps.map((step, index) => (
            ...
            >
              <div
                className={`w-20 h-20 md:w-24 md:h-24 rounded-2xl border-2 ${colorStyles[step.color as keyof typeof colorStyles]} flex items-center justify-center mb-6 relative`}
              >
                {step.icon}
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/10 via-accent/10 to-primary/5 border border-primary/20 p-8 md:p-10 hover:border-primary/40 transition-all group">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-muted-foreground">Consultez notre FAQ pour tout savoir sur l'ANR</p>
                </div>

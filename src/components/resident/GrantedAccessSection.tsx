...
const GrantedAccessSection = () => {
  ...
  return (
    <div className="glass-effect rounded-2xl p-4 border-2 border-green-500">
      <div className="flex items-center gap-2 mb-4">
        <div className="w-10 h-10 rounded-xl bg-green-500/10 flex items-center justify-center border-2 border-green-500">
